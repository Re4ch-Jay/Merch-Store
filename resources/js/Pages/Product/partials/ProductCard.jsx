    ...
    <div className="w-full max-w-sm bg-white border rounded-lg shadow border-gray-700">
        ...
        <div className="px-5 pb-5">
            ...
            <div className="flex items-center justify-between">
                ...
                <button onClick={() => addToCart(product)} className="bg-blue-700 text-white hover:bg-blue-800 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-blue-800">Add to cart</button>
            </div>
        </div>
    </div>
